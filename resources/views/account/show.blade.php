<x-layout>
    ...
    <form method="post" action="{{ route('account.update', $account->id) }}">
        ...
        <input type="text" name="script_params" class="border-2 border-gray-300 rounded-lg p-2 mb-2 w-full" value="{{ $account->script_params }}" />
        <div>World (f2p, members, or world ID)</div>
        <input type="text" name="world" class="border-2 border-gray-300 rounded-lg p-2 mb-2 w-full" value="{{ $account->world }}" />
        <div>FPS</div>
        <input type="number" name="fps" class="border-2 border-gray-300 rounded-lg p-2 mb-2 w-full" value="{{ $account->fps }}"  />

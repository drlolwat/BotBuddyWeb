                            ...
                            <details class="mb-4">
                                ...
                                <div>
                                    ...
                                    <div class="grid gap-1 mb-4 sm:grid-cols-2 sm:mb-5">
                                        ...
                                        @if(isset(auth()->user()->subscription) && in_array(auth()->user()->subscription->name, ['Farm', 'Founder']))
                                            <div class="flex items-center space-x-4 mb-2">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <div class="font-bold text-gray-900 dark:text-white">Accounts in {{ $group->name }}</div>
                    </div>
                    {{-- todo: populate account create page with defaults from account group --}}
